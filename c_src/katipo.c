...
static void set_method(long method, ConnInfo *conn) {
  switch (method) {
    case KATIPO_GET:
        curl_easy_setopt(conn->easy, CURLOPT_SSL_FALSESTART, 1);
        curl_easy_setopt(conn->easy, CURLOPT_SSLVERSION, CURL_SSLVERSION_TLSv1_2);
        curl_easy_setopt(conn->easy, CURLOPT_SSL_CERT_COMPRESSION, "brotli");
        curl_easy_setopt(conn->easy, CURLOPT_SSL_ENABLE_NPN, 0);
        curl_easy_setopt(conn->easy, CURLOPT_SSL_ENABLE_ALPN, 1);
        curl_easy_setopt(conn->easy, CURLOPT_SSL_ENABLE_ALPS, 1);
        curl_easy_setopt(conn->easy, CURLOPT_SSL_ENABLE_TICKET, 1);
        curl_easy_setopt(conn->easy, CURLOPT_SSL_CIPHER_LIST, "TLS_AES_128_GCM_SHA256,TLS_AES_256_GCM_SHA384,TLS_CHACHA20_POLY1305_SHA256,ECDHE-ECDSA-AES128-GCM-SHA256,ECDHE-RSA-AES128-GCM-SHA256,ECDHE-ECDSA-AES256-GCM-SHA384,ECDHE-RSA-AES256-GCM-SHA384,ECDHE-ECDSA-CHACHA20-POLY1305,ECDHE-RSA-CHACHA20-POLY1305,ECDHE-RSA-AES128-SHA,ECDHE-RSA-AES256-SHA,AES128-GCM-SHA256,AES256-GCM-SHA384,AES128-SHA,AES256-SHA");
      break;
    case KATIPO_POST:
...
static void new_conn(long method, char *url, struct curl_slist *req_headers,
  ...
  curl_easy_setopt(conn->easy, CURLOPT_ACCEPT_ENCODING, "gzip,deflate,br");
